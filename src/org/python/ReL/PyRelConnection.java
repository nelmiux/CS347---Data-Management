...
System.out.println("________________ mode: " + model);
    ...
    public int addToSession(PyObject obj) { 
        ...
        inst_dict = ((PyStringMap)obj.fastGetDict()).getTable();
    ...
    private void insertInstance(PyObjectDerived instance, SIMHelper simHelper)
    {
        ...
        simHelper.executeInstance(((PyStringMap)instance.getDict()).getTable().get("DBUNIQUEID").toString(), instance.getType().getName());
        //Add the member data. 
          ...
          for (Map.Entry<Object, PyObject> entry : data.entrySet()) {
              ...
              if(!used_vars.contains(key.toString()))
              {
                  ...
                  { 
                      ...
                      simHelper.executeMemberData(((PyStringMap)instance.getDict()).getTable().get("DBUNIQUEID").toString(), value_type, key.toString(), value.toString());
