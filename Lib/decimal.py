...
"""
This is a Py2.3 implementation of decimal floating point arithmetic based on_
...
class InvalidContext(InvalidOperation):
    ...
    on_ creation and either the precision exceeds the capability of the
...
class Overflow(Inexact, Rounded):
    ...
    The result depends on_ the rounding mode:
...
class Decimal(object):
    ...
    def __new__(cls, value="0", context=None):
        ...
        # that are used in almost every arithmetic operation on_
        ...
        # From a string
        # REs insist on_ real strings, so we can too.
    ...
    # don't use it (see notes on_ Py2.3 compatibility at top of file)
    ...
    # Decimals.  In particular, the specification is silent on_ the
    ...
    def __hash__(self):
        ...
        # on_ the value of that Decimal, and not on_ its representation.
    ...
    def __str__(self, eng=False, context=None):
        ...
        if self._exp <= 0 and leftdigits > -6:
            ...
            # usual scientific notation: 1 digit on_ left of the point
            dotplace = 1
        elif self._int == '0':
    ...
    def _fix(self, context):
        ...
        Rounds and fixes the exponent.  Does not raise on_ a sNaN.
        ...
        if self._exp < exp_min:
            ...
            context._raise_error(Rounded)
            if not ans:
                # raise Clamped on_ underflow to 0
                context._raise_error(Clamped)
            return ans
    ...
    def _power_exact(self, other, p):
        ...
        # these tests are passed do we go on_ to actually compute x**y.
    ...
    def __pow__(self, other, modulo=None, context=None):
        ...
        three argument form, the following restrictions on_ the
        arguments hold:
        ...
        # depend on_ the exponent of self, and on_ whether other is a
        ...
        # from here on_, the result always goes through the call
    ...
    def _log10_exp_bound(self):
        ...
        # For x >= 10 or x < 0.1 we only need a bound on_ the integer
    ...
    def __format__(self, specifier, context=None, _localeconv=None):
        ...
        type is omitted it defaults to 'g' or 'G', depending on_ the
        ...
        # a type of None defaults to 'g' or 'G', depending on_ context
...
class Context(object):
    ...
    def _raise_error(self, condition, explanation = None, *args):
        ...
        # Errors should only be risked on_ copies of the context
        # self._ignored_flags = []
    ...
    def abs(self, a):
        ...
        operation on_ the operand.  Otherwise, the result is the same as using
        the plus operation on_ the operand.
    ...
    def remainder(self, a, b):
        ...
        (that is, if integer division on_ the same two operands would fail, the
...
def _ilog(x, M, L = 8):
    ...
    both cases these are upper bounds on_ the error; it will usually be
    much smaller."""
...
def _insert_thousands_sep(digits, spec, min_width=1):
    ...
    result, which will be padded on_ the left with zeros if necessary.

    If necessary, the zero padding adds an extra '0' on_ the left to
